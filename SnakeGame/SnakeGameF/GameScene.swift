...
class GameScene: SKScene {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if let shapeNode = touchedNode as? SKShapeNode,
            ...
            shapeNode.fillColor = .systemYellow
    ...
    private func setup(in view: SKView) {
        ...
        startButton = SKLabelNode(text: "NEW GAME")
        startButton.position = CGPoint(x: scene.frame.midX - 5, y: 55)
    ...
    final func drawGameFrame() {
        ...
        gameFrameView.strokeColor = .systemYellow
